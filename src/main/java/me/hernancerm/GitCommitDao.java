...
public class GitCommitDao {
    ...
    public String getItem(String hash, String item) {
        return getItem(hash, item, List.of());
    }

    public String getItem(String hash, String item, String arg) {
        return getItem(hash, item, List.of(arg));
    }

    public String getItem(String hash, String item, List<String> args) {
        Process process;
        try {
